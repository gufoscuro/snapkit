...
/**
 * Schema for the supplier data consumed by this component.
 * Matches the shape provided by SupplierDetails.
 */
...
const SupplierDataSchema = Type.Object({
  id: Type.String(),
  type: Type.Union([
...
/**
 * Contract for SupplierSidebar component.
 * - Provides: nothing
 * - Consumes: supplier data (provided by SupplierDetails on the same page)
 */
export const SupplierSidebarContract = {
  $id: 'SupplierSidebar',
  provides: {},
  consumes: {
