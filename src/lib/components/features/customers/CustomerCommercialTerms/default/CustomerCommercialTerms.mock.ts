...
/**
 * Mock props for CustomerCommercialTerms component preview
 */
export const mockCustomerCommercialTermsProps: SnippetProps = {
  pageDetails: {
    config: {
  ...
  routeDetails: {
    url: new URL('http://localhost:5173/contacts/customers/upsert/00000000-0000-0000-0000-000000000001/commercial-terms'),
    search: null,
  },
  entityConfig: null,
  user: null,
